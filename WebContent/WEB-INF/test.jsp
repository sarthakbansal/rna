...
<head>
    ...
    <title>RNA Logistics</title>

    <!-- Bootstrap Core CSS -->
	<spring:url value="/resources/css/bootstrap.min.css" var="bootstrap2CSS" />
	<spring:url value="/resources/css/bootstrap.css" var="bootstrapCSS" />
	<spring:url value="/resources/css/agency.css" var="agencyCSS" />
	...
	<spring:url value="/resources/js/cbpAnimatedHeader.js" var="cbpAnimatedHeaderJS" />
	...
	<spring:url value="/resources/js/agency.js" var="agencyJS" />
...
<li>Add Company</li>
				<div class="admin">
					<table>
						<tr><td>Company Name: </td><td><input type="text" name="username" /></td><td><span class="error"></span></td></tr>
						<tr><td>Address: </td><td><input type="text" name="username" /></td><td><span class="error"></span></td></tr>
